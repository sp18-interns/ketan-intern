-- DROP SCHEMA nobroker CASCADE;

CREATE SCHEMA nobroker AUTHORIZATION postgres;

-- nobroker."location" definition

-- Drop table

-- DROP TABLE nobroker."location";

CREATE TABLE nobroker."location" (
...
CREATE TABLE nobroker.address (
	...
	CONSTRAINT address_location_id_fkey FOREIGN KEY (location_id) REFERENCES nobroker."location"(location_id)
);

-- nobroker.charged_category definition

-- Drop table

-- DROP TABLE nobroker.charged_category;

CREATE TABLE nobroker.charged_category (
	charged_category_id int8 NOT NULL,
	perticular_amount varchar(100) NOT NULL,
	CONSTRAINT charged_category_pkey PRIMARY KEY (charged_category_id)
);
...
CREATE TABLE nobroker.nearby_spots (
	...
	nearby_type_id int8 NOT NULL,
	location_id int8 NOT NULL,
	CONSTRAINT nearby_spots_location_id_fkey FOREIGN KEY (location_id) REFERENCES nobroker."location"(location_id),
...
-- nobroker.listing_costing definition

-- Drop table

-- DROP TABLE nobroker.listing_costing;

CREATE TABLE nobroker.listing_costing (
	listing_costing_id int8 NOT NULL,
	propertylisting_id int8 NOT NULL,
	charged_category_id int8 NOT NULL,
	CONSTRAINT listing_costing_charged_category_id_fkey FOREIGN KEY (charged_category_id) REFERENCES nobroker.charged_category(charged_category_id),
	CONSTRAINT listing_costing_propertylisting_id_fkey FOREIGN KEY (propertylisting_id) REFERENCES nobroker.property_listing(propertylisting_id)
);
